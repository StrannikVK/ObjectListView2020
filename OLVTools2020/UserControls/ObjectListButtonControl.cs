...
namespace OLVTools2020
{
    public partial class ObjectListButtonControl : UserControl
    {
        ...
        //private List<ObjectToControl> list_Of_ObjectToControl = new List<ObjectToControl>();
        //public List<ObjectToControl> List_OfObjectToControl
        //{
        //    get { return list_Of_ObjectToControl; }
        //    set { list_Of_ObjectToControl = value;}
        //}
        //private void SetupGeneralListViewEvents()
        //{
        //    if (this.ListView == null || this.OLV_Mgr == null)
        //        return;

        //    this.ListView.SelectionChanged += delegate (object sender, EventArgs args) {
        //        this.OLV_Mgr.HandleSelectionChanged(this.ListView);
        //    };

        //    this.ListView.HotItemChanged += delegate (object sender, HotItemChangedEventArgs args) {
        //        this.OLV_Mgr.HandleHotItemChanged(sender, args);
        //    };

        //    this.ListView.GroupTaskClicked += delegate (object sender, GroupTaskClickedEventArgs args) {
        //        OLV_Mgr.ShowMessage("Clicked on group task: " + args.Group.Name);
        //    };
