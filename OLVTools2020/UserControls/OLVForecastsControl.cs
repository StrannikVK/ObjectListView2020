...
{
    public partial class OLVForecastsControl : UserControl
    {
        ...
        //public string Filter_Last_Propertie { get; set; } = "Name";
        //public string Filter_Last_Condition { get; set; } = ">";
        //public string Filter_Last_Value { get; set; } = "0";


        public OLVForecastsControl()
        {
            InitializeComponent();
        ...
        public void Set_List_Of_Object(List<object> oList_Of_Object, object oObject_Mgr)
        {
            ...
            Gen_Tools.Bind_To_Propertie_Async(comboBox_Parameters, "Text", _Object_Mgr, "Filter_Last_Propertie", false);
            Gen_Tools.Bind_To_Propertie_Async(comboBox_Condition, "Text", _Object_Mgr, "Filter_Last_Condition", false);
            Gen_Tools.Bind_To_Propertie_Async(textBox_Filter_Value, "Text", _Object_Mgr, "Filter_Last_Value", false);
        ...
        private void button_Get_All_Forecast_Properties_Click(object sender, EventArgs e)
        {
            object oModel = OLV_Objects.SelectedObject;
            object oobject = (object)oModel;
            try { propertyGrid_Forecast_Object.SelectedObject = oobject; }
            catch (Exception ex) { string oDebug = ex.Message; }
        }
