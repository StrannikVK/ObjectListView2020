        ...
        private void listViewComplex_CellEditValidating(object sender, CellEditEventArgs e) {
            ...
            if (e.Column.Text == "Occupation") {
                ...
                if (newValue.StartsWith("a") || newValue.StartsWith("z")) {
                    e.Cancel = true;
                    MessageBox.Show(this, "Occupations cannot begin with 'a' or 'z' (just to show cell edit validation at work).", "OLVTools2020",
            ...
            if (e.Column.Text == "Birthday") {
                ...
                if (newValue.Day == 29) {
                    e.Cancel = true;
                    MessageBox.Show(this, "Sorry. Birthdays cannot be on 29th of any month (just to show cell edit validation at work).", "OLVTools2020",
                        MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
            }
        }
